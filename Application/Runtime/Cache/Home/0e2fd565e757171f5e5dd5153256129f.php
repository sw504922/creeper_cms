...
<li><a href='./index.php?m=&c=Operatelog&a=index'>操作日志</a></li>
 ...
 <div class="cur_box">
  ...
  <div class="table-responsive table_box" id='total'>
    <form role="form" action='/creeper_cms/index.php?m=&c=Job&a=jobList&id=172'>
    <div class="col-xs-2">
	      <label>开始时间：</label>
...
<div class="form-group">
  <label>cookies：</label><span><?php echo $re['cookies'];?></<span>
...
<div class="form-group" id='show_time' style='display:<?php echo $re['crawl_repeat']==1?'':'none';?>;'>
  ...
  <div class="form-group">
    <label>重抓次数：</label><span><?php echo $re['error_retry'];?></span>
  </div>
  <div class="form-group">
    <label>超时时间：</label><span><?php echo $re['timeout'];?></span>
  </div>
  <div class="form-group">
    <label>last_crawl_at：</label><span><?php echo $re['last_crawl_at'];?></span>
  </div>
  <div class="form-group">
    <label>handler_id：</label><span><?php echo $re['handler_id'];?></span>
  </div>
  <div class="form-group">
    <label>queue_name：</label><span><?php echo $re['queue_name'];?></span>
  </div>
  <div class="form-group">
    <label>valid_time(分钟)：</label><span><?php echo $re['valid_time'];?></span>
  </div>
</div>
   ...
   $('#sub_click').live('click',function(){
    ...
    var info = '&id='+id+'&start='+time_s+ time_s1+'&end='+time_e+time_e1;
