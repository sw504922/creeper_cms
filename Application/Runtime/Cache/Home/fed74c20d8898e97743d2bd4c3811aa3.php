...
<div class="title">dispatecher模块的日志展示</div>
  <div style="margin-bottom:10px;">
      ...
      <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1" id='show_status'>
        ...
        <li role="presentation" value='-10'><a role="menuitem" tabindex="-1" href="javascript:void(0)">因为超时而丢弃</a></li>
        <li role="presentation" value='-5'><a role="menuitem" tabindex="-1" href="javascript:void(0)">重新放入schedule</a></li>
        <li role="presentation" value='-4'><a role="menuitem" tabindex="-1" href="javascript:void(0)">从pq中取数量</a></li>
        <li role="presentation" value='-3'><a role="menuitem" tabindex="-1" href="javascript:void(0)">重新放进mq</a></li>
        <li role="presentation" value='-2'><a role="menuitem" tabindex="-1" href="javascript:void(0)">fetcher拒绝</a></li>
        <li role="presentation" value='-1'><a role="menuitem" tabindex="-1" href="javascript:void(0)">fetcher成功接收</a></li>
...
function detail(job_id,type){
  location.href = 'index.php?m=&c=Log&a=indexDispatcherList&job_id='+job_id+'&type='+type
}
$('#btn_submit').live('click',function(){
    ...
    $.get('./index.php?m=&c=Log&a=getDataDispatcher',info, function(data){
      //console.log(data.curve);
        if(data.status == 1){
          $('#table_dispatcher').html(data.content);
        }else{
          alert(data.msg);
        }
     })
