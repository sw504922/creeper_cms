/*
 ...
 Source Schema         : miningaccount_us

 Target Server Type    : MySQL
 Target Server Version : 50721
 File Encoding         : 65001

 Date: 27/05/2022 15:19:48
*/
...
CREATE TABLE `account_dictionary` (
  ...
  `value` varchar(100) DEFAULT NULL COMMENT '属性内容',
  `sequence` int(11) DEFAULT '0' COMMENT '排序',
  `availability` char(2) NOT NULL DEFAULT '0' COMMENT '有效性：0有效 1无效',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=98 DEFAULT CHARSET=utf8mb4 COMMENT='开户相关属性字典表';
...
) ENGINE=InnoDB AUTO_INCREMENT=122756 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `account_info_org` (
  ...
  `question5_answer3` varchar(50) DEFAULT NULL,
...
CREATE TABLE `account_market_change_audit` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3182 DEFAULT CHARSET=utf8mb4 COMMENT='增开 美股和中华通 市场';
...
CREATE TABLE `account_market_change_audit_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12237 DEFAULT CHARSET=utf8mb4 COMMENT='增开美股中华通市场，审核日志';
...
CREATE TABLE `account_type_change_audit` (
  ...
  `insert_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4098 DEFAULT CHARSET=utf8mb4 COMMENT='转为现金账户审核\r\n\r\n转为保证金审核';
...
CREATE TABLE `account_type_change_audit_log` (
  ...
  `inset_time` datetime DEFAULT NULL COMMENT '审核时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15878 DEFAULT CHARSET=utf8mb4 COMMENT='账号类型变更，审核日志';
...
CREATE TABLE `ca_result` (
  ...
  `status` int(2) DEFAULT NULL COMMENT '申请状态  0 正在申请  1 申请成功，等待签署   2 申请失败  3签署成功  4签署失败,5ca异常',
  `result` text COMMENT '结果和失败的原因',
...
CREATE TABLE `check_bank_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=77420 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `check_id_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=114490 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `conversion_assets` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13707 DEFAULT CHARSET=utf8;
...
CREATE TABLE `currency_conversion` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14161 DEFAULT CHARSET=utf8mb4;
...
) ENGINE=InnoDB AUTO_INCREMENT=261494 DEFAULT CHARSET=utf8mb4 COMMENT='入金审核';

-- ----------------------------
-- Table structure for deposit_audite_copy202004151520
-- ----------------------------
DROP TABLE IF EXISTS `deposit_audite_copy202004151520`;
CREATE TABLE `deposit_audite_copy202004151520` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `deposit_id` bigint(11) DEFAULT NULL COMMENT '入金主键',
  `audit_role` tinyint(4) DEFAULT NULL COMMENT '审核角色  1:交易员 2;会计 3:结算员',
  `auditor` varchar(100) DEFAULT NULL COMMENT '审核人',
  ...
  KEY `depositId` (`deposit_id`),
  KEY `auditStatus` (`audit_status`)
) ENGINE=InnoDB AUTO_INCREMENT=175453 DEFAULT CHARSET=utf8mb4 COMMENT='入金审核';

-- ----------------------------
-- Table structure for deposit_audite_copy202005061337
-- ----------------------------
DROP TABLE IF EXISTS `deposit_audite_copy202005061337`;
CREATE TABLE `deposit_audite_copy202005061337` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `deposit_id` bigint(11) DEFAULT NULL COMMENT '入金主键',
  `audit_role` tinyint(4) DEFAULT NULL COMMENT '审核角色  1:交易员 2;会计 3:结算员',
  `auditor` varchar(100) DEFAULT NULL COMMENT '审核人',
  ...
  KEY `depositId` (`deposit_id`),
  KEY `auditStatus` (`audit_status`)
) ENGINE=InnoDB AUTO_INCREMENT=193666 DEFAULT CHARSET=utf8mb4 COMMENT='入金审核';

-- ----------------------------
-- Table structure for deposit_audite_copy202005111326
-- ----------------------------
DROP TABLE IF EXISTS `deposit_audite_copy202005111326`;
CREATE TABLE `deposit_audite_copy202005111326` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `deposit_id` bigint(11) DEFAULT NULL COMMENT '入金主键',
  `audit_role` tinyint(4) DEFAULT NULL COMMENT '审核角色  1:交易员 2;会计 3:结算员',
  `auditor` varchar(100) DEFAULT NULL COMMENT '审核人',
  ...
  KEY `depositId` (`deposit_id`),
  KEY `auditStatus` (`audit_status`)
) ENGINE=InnoDB AUTO_INCREMENT=198749 DEFAULT CHARSET=utf8mb4 COMMENT='入金审核';

-- ----------------------------
-- Table structure for deposit_audite_copy202005141326
-- ----------------------------
DROP TABLE IF EXISTS `deposit_audite_copy202005141326`;
CREATE TABLE `deposit_audite_copy202005141326` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `deposit_id` bigint(11) DEFAULT NULL COMMENT '入金主键',
  `audit_role` tinyint(4) DEFAULT NULL COMMENT '审核角色  1:交易员 2;会计 3:结算员',
  `auditor` varchar(100) DEFAULT NULL COMMENT '审核人',
  ...
  KEY `depositId` (`deposit_id`),
  KEY `auditStatus` (`audit_status`)
) ENGINE=InnoDB AUTO_INCREMENT=203236 DEFAULT CHARSET=utf8mb4 COMMENT='入金审核';

-- ----------------------------
-- Table structure for deposit_audite_copy202005151807
-- ----------------------------
DROP TABLE IF EXISTS `deposit_audite_copy202005151807`;
CREATE TABLE `deposit_audite_copy202005151807` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `deposit_id` bigint(11) DEFAULT NULL COMMENT '入金主键',
  `audit_role` tinyint(4) DEFAULT NULL COMMENT '审核角色  1:交易员 2;会计 3:结算员',
  `auditor` varchar(100) DEFAULT NULL COMMENT '审核人',
  ...
  KEY `depositId` (`deposit_id`),
  KEY `auditStatus` (`audit_status`)
) ENGINE=InnoDB AUTO_INCREMENT=205497 DEFAULT CHARSET=utf8mb4 COMMENT='入金审核';

-- ----------------------------
-- Table structure for deposit_audite_copy202006021415
-- ----------------------------
DROP TABLE IF EXISTS `deposit_audite_copy202006021415`;
CREATE TABLE `deposit_audite_copy202006021415` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `deposit_id` bigint(11) DEFAULT NULL COMMENT '入金主键',
  `audit_role` tinyint(4) DEFAULT NULL COMMENT '审核角色  1:交易员 2;会计 3:结算员',
  `auditor` varchar(100) DEFAULT NULL COMMENT '审核人',
  ...
  KEY `depositId` (`deposit_id`),
  KEY `auditStatus` (`audit_status`)
) ENGINE=InnoDB AUTO_INCREMENT=228351 DEFAULT CHARSET=utf8mb4 COMMENT='入金审核';

-- ----------------------------
-- Table structure for deposit_audite_copy202006021522
-- ----------------------------
DROP TABLE IF EXISTS `deposit_audite_copy202006021522`;
CREATE TABLE `deposit_audite_copy202006021522` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `deposit_id` bigint(11) DEFAULT NULL COMMENT '入金主键',
  `audit_role` tinyint(4) DEFAULT NULL COMMENT '审核角色  1:交易员 2;会计 3:结算员',
  `auditor` varchar(100) DEFAULT NULL COMMENT '审核人',
  ...
  KEY `depositId` (`deposit_id`),
  KEY `auditStatus` (`audit_status`)
) ENGINE=InnoDB AUTO_INCREMENT=228720 DEFAULT CHARSET=utf8mb4 COMMENT='入金审核';

-- ----------------------------
-- Table structure for deposit_audite_copy202006091013
-- ----------------------------
DROP TABLE IF EXISTS `deposit_audite_copy202006091013`;
CREATE TABLE `deposit_audite_copy202006091013` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `deposit_id` bigint(11) DEFAULT NULL COMMENT '入金主键',
  `audit_role` tinyint(4) DEFAULT NULL COMMENT '审核角色  1:交易员 2;会计 3:结算员',
  `auditor` varchar(100) DEFAULT NULL COMMENT '审核人',
  ...
  KEY `depositId` (`deposit_id`),
  KEY `auditStatus` (`audit_status`)
) ENGINE=InnoDB AUTO_INCREMENT=241212 DEFAULT CHARSET=utf8mb4 COMMENT='入金审核';

-- ----------------------------
-- Table structure for deposit_audite_copy202006111649
-- ----------------------------
DROP TABLE IF EXISTS `deposit_audite_copy202006111649`;
CREATE TABLE `deposit_audite_copy202006111649` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `deposit_id` bigint(11) DEFAULT NULL COMMENT '入金主键',
  `audit_role` tinyint(4) DEFAULT NULL COMMENT '审核角色  1:交易员 2;会计 3:结算员',
  `auditor` varchar(100) DEFAULT NULL COMMENT '审核人',
  ...
  KEY `depositId` (`deposit_id`),
  KEY `auditStatus` (`audit_status`)
) ENGINE=InnoDB AUTO_INCREMENT=245178 DEFAULT CHARSET=utf8mb4 COMMENT='入金审核';

-- ----------------------------
-- Table structure for deposit_audite_copy202006161030
-- ----------------------------
DROP TABLE IF EXISTS `deposit_audite_copy202006161030`;
CREATE TABLE `deposit_audite_copy202006161030` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `deposit_id` bigint(11) DEFAULT NULL COMMENT '入金主键',
  `audit_role` tinyint(4) DEFAULT NULL COMMENT '审核角色  1:交易员 2;会计 3:结算员',
  `auditor` varchar(100) DEFAULT NULL COMMENT '审核人',
  ...
  KEY `depositId` (`deposit_id`),
  KEY `auditStatus` (`audit_status`)
) ENGINE=InnoDB AUTO_INCREMENT=248017 DEFAULT CHARSET=utf8mb4 COMMENT='入金审核';

-- ----------------------------
-- Table structure for deposit_audite_copy202006181448
-- ----------------------------
DROP TABLE IF EXISTS `deposit_audite_copy202006181448`;
CREATE TABLE `deposit_audite_copy202006181448` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `deposit_id` bigint(11) DEFAULT NULL COMMENT '入金主键',
  `audit_role` tinyint(4) DEFAULT NULL COMMENT '审核角色  1:交易员 2;会计 3:结算员',
  `auditor` varchar(100) DEFAULT NULL COMMENT '审核人',
  ...
  KEY `depositId` (`deposit_id`),
  KEY `auditStatus` (`audit_status`)
) ENGINE=InnoDB AUTO_INCREMENT=253689 DEFAULT CHARSET=utf8mb4 COMMENT='入金审核';
...
) ENGINE=InnoDB AUTO_INCREMENT=100956 DEFAULT CHARSET=utf8mb4 COMMENT='入金信息';

-- ----------------------------
-- Table structure for deposit_detail_copy202001081530
-- ----------------------------
DROP TABLE IF EXISTS `deposit_detail_copy202001081530`;
CREATE TABLE `deposit_detail_copy202001081530` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `transfer_money_apply_id` int(11) DEFAULT NULL,
  `account_name` varchar(50) DEFAULT NULL COMMENT '开户名称',
  `funds_account` varchar(50) DEFAULT NULL COMMENT '资金账号',
  `phone_mobile` varchar(20) DEFAULT NULL COMMENT '开户电话',
  `area_country_code` varchar(8) DEFAULT '+86' COMMENT '手机区域号',
  `currency` tinyint(4) DEFAULT NULL COMMENT '2:港币;3:美元',
  ...
  KEY `auditStatus` (`audit_status`),
  KEY `idx_transfer_certificate_no` (`transfer_certificate_no`)
) ENGINE=InnoDB AUTO_INCREMENT=45104 DEFAULT CHARSET=utf8mb4 COMMENT='入金信息';

-- ----------------------------
-- Table structure for deposit_detail_copy202001101734
-- ----------------------------
DROP TABLE IF EXISTS `deposit_detail_copy202001101734`;
CREATE TABLE `deposit_detail_copy202001101734` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `transfer_money_apply_id` int(11) DEFAULT NULL,
  `account_name` varchar(50) DEFAULT NULL COMMENT '开户名称',
  `funds_account` varchar(50) DEFAULT NULL COMMENT '资金账号',
  ...
  KEY `auditStatus` (`audit_status`),
  KEY `idx_transfer_certificate_no` (`transfer_certificate_no`)
) ENGINE=InnoDB AUTO_INCREMENT=45663 DEFAULT CHARSET=utf8mb4 COMMENT='入金信息';

-- ----------------------------
-- Table structure for deposit_detail_copy202004151520
-- ----------------------------
DROP TABLE IF EXISTS `deposit_detail_copy202004151520`;
CREATE TABLE `deposit_detail_copy202004151520` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `transfer_money_apply_id` int(11) DEFAULT NULL,
  `account_name` varchar(150) DEFAULT NULL COMMENT '开户名称',
  `funds_account` varchar(50) DEFAULT NULL COMMENT '资金账号',
  ...
  `no_automatic_reason` varchar(20) DEFAULT NULL COMMENT '没进入自动列表原因',
  `deposit_fail_code` varchar(20) DEFAULT NULL COMMENT '银证转账入金失败代码',
  `deposit_fail_reason` varchar(50) DEFAULT NULL COMMENT '银证转账入金失败原因',
  `bank_reference` varchar(50) DEFAULT NULL COMMENT '银证转账银行流水号',
  PRIMARY KEY (`id`),
  KEY `fundsAccount` (`funds_account`),
  KEY `phoneNumber` (`phone_mobile`),
  ...
  KEY `auditStatus` (`audit_status`),
  KEY `idx_transfer_certificate_no` (`transfer_certificate_no`)
) ENGINE=InnoDB AUTO_INCREMENT=64831 DEFAULT CHARSET=utf8mb4 COMMENT='入金信息';

-- ----------------------------
-- Table structure for deposit_detail_copy202005061337
-- ----------------------------
DROP TABLE IF EXISTS `deposit_detail_copy202005061337`;
CREATE TABLE `deposit_detail_copy202005061337` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `transfer_money_apply_id` int(11) DEFAULT NULL,
  `account_name` varchar(150) DEFAULT NULL COMMENT '开户名称',
  `funds_account` varchar(50) DEFAULT NULL COMMENT '资金账号',
  ...
  KEY `auditStatus` (`audit_status`),
  KEY `idx_transfer_certificate_no` (`transfer_certificate_no`)
) ENGINE=InnoDB AUTO_INCREMENT=73926 DEFAULT CHARSET=utf8mb4 COMMENT='入金信息';

-- ----------------------------
-- Table structure for deposit_detail_copy202005111326
-- ----------------------------
DROP TABLE IF EXISTS `deposit_detail_copy202005111326`;
CREATE TABLE `deposit_detail_copy202005111326` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `transfer_money_apply_id` int(11) DEFAULT NULL,
  `account_name` varchar(150) DEFAULT NULL COMMENT '开户名称',
  `funds_account` varchar(50) DEFAULT NULL COMMENT '资金账号',
  ...
  KEY `auditStatus` (`audit_status`),
  KEY `idx_transfer_certificate_no` (`transfer_certificate_no`)
) ENGINE=InnoDB AUTO_INCREMENT=76189 DEFAULT CHARSET=utf8mb4 COMMENT='入金信息';

-- ----------------------------
-- Table structure for deposit_detail_copy202005141326
-- ----------------------------
DROP TABLE IF EXISTS `deposit_detail_copy202005141326`;
CREATE TABLE `deposit_detail_copy202005141326` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `transfer_money_apply_id` int(11) DEFAULT NULL,
  `account_name` varchar(150) DEFAULT NULL COMMENT '开户名称',
  `funds_account` varchar(50) DEFAULT NULL COMMENT '资金账号',
  ...
  KEY `auditStatus` (`audit_status`),
  KEY `idx_transfer_certificate_no` (`transfer_certificate_no`)
) ENGINE=InnoDB AUTO_INCREMENT=78122 DEFAULT CHARSET=utf8mb4 COMMENT='入金信息';

-- ----------------------------
-- Table structure for deposit_detail_copy202005151807
-- ----------------------------
DROP TABLE IF EXISTS `deposit_detail_copy202005151807`;
CREATE TABLE `deposit_detail_copy202005151807` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `transfer_money_apply_id` int(11) DEFAULT NULL,
  `account_name` varchar(150) DEFAULT NULL COMMENT '开户名称',
  `funds_account` varchar(50) DEFAULT NULL COMMENT '资金账号',
  ...
  KEY `auditStatus` (`audit_status`),
  KEY `idx_transfer_certificate_no` (`transfer_certificate_no`)
) ENGINE=InnoDB AUTO_INCREMENT=79233 DEFAULT CHARSET=utf8mb4 COMMENT='入金信息';

-- ----------------------------
-- Table structure for deposit_detail_copy202006021415
-- ----------------------------
DROP TABLE IF EXISTS `deposit_detail_copy202006021415`;
CREATE TABLE `deposit_detail_copy202006021415` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `transfer_money_apply_id` int(11) DEFAULT NULL,
  `account_name` varchar(150) DEFAULT NULL COMMENT '开户名称',
  `funds_account` varchar(50) DEFAULT NULL COMMENT '资金账号',
  ...
  KEY `auditStatus` (`audit_status`),
  KEY `idx_transfer_certificate_no` (`transfer_certificate_no`)
) ENGINE=InnoDB AUTO_INCREMENT=86892 DEFAULT CHARSET=utf8mb4 COMMENT='入金信息';

-- ----------------------------
-- Table structure for deposit_detail_copy202006021522
-- ----------------------------
DROP TABLE IF EXISTS `deposit_detail_copy202006021522`;
CREATE TABLE `deposit_detail_copy202006021522` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `transfer_money_apply_id` int(11) DEFAULT NULL,
  `account_name` varchar(150) DEFAULT NULL COMMENT '开户名称',
  `funds_account` varchar(50) DEFAULT NULL COMMENT '资金账号',
  ...
  KEY `auditStatus` (`audit_status`),
  KEY `idx_transfer_certificate_no` (`transfer_certificate_no`)
) ENGINE=InnoDB AUTO_INCREMENT=87025 DEFAULT CHARSET=utf8mb4 COMMENT='入金信息';

-- ----------------------------
-- Table structure for deposit_detail_copy202006091013
-- ----------------------------
DROP TABLE IF EXISTS `deposit_detail_copy202006091013`;
CREATE TABLE `deposit_detail_copy202006091013` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `transfer_money_apply_id` int(11) DEFAULT NULL,
  `account_name` varchar(150) DEFAULT NULL COMMENT '开户名称',
  `funds_account` varchar(50) DEFAULT NULL COMMENT '资金账号',
  ...
  KEY `auditStatus` (`audit_status`),
  KEY `idx_transfer_certificate_no` (`transfer_certificate_no`)
) ENGINE=InnoDB AUTO_INCREMENT=91620 DEFAULT CHARSET=utf8mb4 COMMENT='入金信息';

-- ----------------------------
-- Table structure for deposit_detail_copy202006111649
-- ----------------------------
DROP TABLE IF EXISTS `deposit_detail_copy202006111649`;
CREATE TABLE `deposit_detail_copy202006111649` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `transfer_money_apply_id` int(11) DEFAULT NULL,
  `account_name` varchar(150) DEFAULT NULL COMMENT '开户名称',
  `funds_account` varchar(50) DEFAULT NULL COMMENT '资金账号',
  ...
  KEY `auditStatus` (`audit_status`),
  KEY `idx_transfer_certificate_no` (`transfer_certificate_no`)
) ENGINE=InnoDB AUTO_INCREMENT=93321 DEFAULT CHARSET=utf8mb4 COMMENT='入金信息';

-- ----------------------------
-- Table structure for deposit_detail_copy202006112227
-- ----------------------------
DROP TABLE IF EXISTS `deposit_detail_copy202006112227`;
CREATE TABLE `deposit_detail_copy202006112227` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `transfer_money_apply_id` int(11) DEFAULT NULL,
  `account_name` varchar(150) DEFAULT NULL COMMENT '开户名称',
  `funds_account` varchar(50) DEFAULT NULL COMMENT '资金账号',
  ...
  KEY `auditStatus` (`audit_status`),
  KEY `idx_transfer_certificate_no` (`transfer_certificate_no`)
) ENGINE=InnoDB AUTO_INCREMENT=93357 DEFAULT CHARSET=utf8mb4 COMMENT='入金信息';

-- ----------------------------
-- Table structure for deposit_detail_copy202006161030
-- ----------------------------
DROP TABLE IF EXISTS `deposit_detail_copy202006161030`;
CREATE TABLE `deposit_detail_copy202006161030` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `transfer_money_apply_id` int(11) DEFAULT NULL,
  `account_name` varchar(150) DEFAULT NULL COMMENT '开户名称',
  `funds_account` varchar(50) DEFAULT NULL COMMENT '资金账号',
  ...
  KEY `auditStatus` (`audit_status`),
  KEY `idx_transfer_certificate_no` (`transfer_certificate_no`)
) ENGINE=InnoDB AUTO_INCREMENT=94606 DEFAULT CHARSET=utf8mb4 COMMENT='入金信息';

-- ----------------------------
-- Table structure for deposit_detail_copy202006181448
-- ----------------------------
DROP TABLE IF EXISTS `deposit_detail_copy202006181448`;
CREATE TABLE `deposit_detail_copy202006181448` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `transfer_money_apply_id` int(11) DEFAULT NULL,
  `account_name` varchar(150) DEFAULT NULL COMMENT '开户名称',
  `funds_account` varchar(50) DEFAULT NULL COMMENT '资金账号',
  ...
  KEY `auditStatus` (`audit_status`),
  KEY `idx_transfer_certificate_no` (`transfer_certificate_no`)
) ENGINE=InnoDB AUTO_INCREMENT=97303 DEFAULT CHARSET=utf8mb4 COMMENT='入金信息';
...
) ENGINE=InnoDB AUTO_INCREMENT=80579 DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Table structure for deposit_from_bigdata_202001071639
-- ----------------------------
DROP TABLE IF EXISTS `deposit_from_bigdata_202001071639`;
CREATE TABLE `deposit_from_bigdata_202001071639` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT,
  `deposit_id` bigint(11) DEFAULT NULL COMMENT '入金主键',
  `bank` varchar(20) DEFAULT NULL COMMENT '用户的入金汇入的银行，取值（BOC， DBS）',
  `seq_no` varchar(20) DEFAULT NULL COMMENT '交易流水号',
  `acct_no` varchar(20) DEFAULT NULL COMMENT '尊嘉证券在香港BOS/DBS的银行账号',
  `trading_time` varchar(40) DEFAULT NULL COMMENT 'BOS/DBS收到入金的日期和时间, yyyy-mm-dd HH:MM:SS',
  `cur` varchar(20) DEFAULT NULL COMMENT '收到的入金币种（HKD,CNY,USD)',
  `amount` varchar(20) DEFAULT NULL COMMENT '金额',
  `debit_direction` varchar(20) DEFAULT NULL COMMENT '借贷方向，取值：C：入金，D：出金',
  `reciprocal_account` varchar(256) DEFAULT NULL COMMENT '对方账号,出入金用户的银行账号',
  `reciprocal_account_name` longtext COMMENT '对方账号名称',
  `reciprocal_account_bank` longtext COMMENT '对方开户银行',
  `reciprocal_account_address` varchar(20) DEFAULT NULL COMMENT '对方开户地',
  `transfer_bank` varchar(20) DEFAULT NULL COMMENT '中转银行',
  ...
  PRIMARY KEY (`id`),
  KEY `idx_deposit_id` (`deposit_id`)
) ENGINE=InnoDB AUTO_INCREMENT=30432 DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Table structure for deposit_from_bigdata_copy202001071815
-- ----------------------------
DROP TABLE IF EXISTS `deposit_from_bigdata_copy202001071815`;
CREATE TABLE `deposit_from_bigdata_copy202001071815` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT,
  `deposit_id` bigint(11) DEFAULT NULL COMMENT '入金主键',
  `bank` varchar(20) DEFAULT NULL COMMENT '用户的入金汇入的银行，取值（BOC， DBS）',
  `seq_no` varchar(20) DEFAULT NULL COMMENT '交易流水号',
  ...
  PRIMARY KEY (`id`),
  KEY `idx_deposit_id` (`deposit_id`)
) ENGINE=InnoDB AUTO_INCREMENT=30485 DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Table structure for deposit_from_bigdata_copy202001081530
-- ----------------------------
DROP TABLE IF EXISTS `deposit_from_bigdata_copy202001081530`;
CREATE TABLE `deposit_from_bigdata_copy202001081530` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT,
  `deposit_id` bigint(11) DEFAULT NULL COMMENT '入金主键',
  `bank` varchar(20) DEFAULT NULL COMMENT '用户的入金汇入的银行，取值（BOC， DBS）',
  `seq_no` varchar(20) DEFAULT NULL COMMENT '交易流水号',
  ...
  PRIMARY KEY (`id`),
  KEY `idx_deposit_id` (`deposit_id`)
) ENGINE=InnoDB AUTO_INCREMENT=30824 DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Table structure for deposit_from_bigdata_copy202004141834
-- ----------------------------
DROP TABLE IF EXISTS `deposit_from_bigdata_copy202004141834`;
CREATE TABLE `deposit_from_bigdata_copy202004141834` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT,
  `deposit_id` bigint(11) DEFAULT NULL COMMENT '入金主键',
  `bank` varchar(20) DEFAULT NULL COMMENT '用户的入金汇入的银行，取值（BOC， DBS）',
  `seq_no` varchar(64) DEFAULT NULL COMMENT '交易流水号',
  ...
  KEY `idx_deposit_id` (`deposit_id`),
  KEY `idx_seq_no` (`seq_no`)
) ENGINE=InnoDB AUTO_INCREMENT=47383 DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Table structure for deposit_from_bigdata_copy202004151520
-- ----------------------------
DROP TABLE IF EXISTS `deposit_from_bigdata_copy202004151520`;
CREATE TABLE `deposit_from_bigdata_copy202004151520` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT,
  `deposit_id` bigint(11) DEFAULT NULL COMMENT '入金主键',
  `bank` varchar(20) DEFAULT NULL COMMENT '用户的入金汇入的银行，取值（BOC， DBS）',
  `seq_no` varchar(64) DEFAULT NULL COMMENT '交易流水号',
  ...
  KEY `idx_deposit_id` (`deposit_id`),
  KEY `idx_seq_no` (`seq_no`)
) ENGINE=InnoDB AUTO_INCREMENT=48414 DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Table structure for deposit_from_bigdata_copy202005061337
-- ----------------------------
DROP TABLE IF EXISTS `deposit_from_bigdata_copy202005061337`;
CREATE TABLE `deposit_from_bigdata_copy202005061337` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT,
  `deposit_id` bigint(11) DEFAULT NULL COMMENT '入金主键',
  `bank` varchar(20) DEFAULT NULL COMMENT '用户的入金汇入的银行，取值（BOC， DBS）',
  `seq_no` varchar(64) DEFAULT NULL COMMENT '交易流水号',
  ...
  KEY `idx_deposit_id` (`deposit_id`),
  KEY `idx_seq_no` (`seq_no`)
) ENGINE=InnoDB AUTO_INCREMENT=56023 DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Table structure for deposit_from_bigdata_copy202005111326
-- ----------------------------
DROP TABLE IF EXISTS `deposit_from_bigdata_copy202005111326`;
CREATE TABLE `deposit_from_bigdata_copy202005111326` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT,
  `deposit_id` bigint(11) DEFAULT NULL COMMENT '入金主键',
  `bank` varchar(20) DEFAULT NULL COMMENT '用户的入金汇入的银行，取值（BOC， DBS）',
  `seq_no` varchar(64) DEFAULT NULL COMMENT '交易流水号',
  ...
  KEY `idx_deposit_id` (`deposit_id`),
  KEY `idx_seq_no` (`seq_no`)
) ENGINE=InnoDB AUTO_INCREMENT=58032 DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Table structure for deposit_from_bigdata_copy202005141326
-- ----------------------------
DROP TABLE IF EXISTS `deposit_from_bigdata_copy202005141326`;
CREATE TABLE `deposit_from_bigdata_copy202005141326` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT,
  `deposit_id` bigint(11) DEFAULT NULL COMMENT '入金主键',
  `bank` varchar(20) DEFAULT NULL COMMENT '用户的入金汇入的银行，取值（BOC， DBS）',
  `seq_no` varchar(64) DEFAULT NULL COMMENT '交易流水号',
  ...
  KEY `idx_deposit_id` (`deposit_id`),
  KEY `idx_seq_no` (`seq_no`)
) ENGINE=InnoDB AUTO_INCREMENT=59763 DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Table structure for deposit_from_bigdata_copy202005151807
-- ----------------------------
DROP TABLE IF EXISTS `deposit_from_bigdata_copy202005151807`;
CREATE TABLE `deposit_from_bigdata_copy202005151807` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT,
  `deposit_id` bigint(11) DEFAULT NULL COMMENT '入金主键',
  `bank` varchar(20) DEFAULT NULL COMMENT '用户的入金汇入的银行，取值（BOC， DBS）',
  `seq_no` varchar(64) DEFAULT NULL COMMENT '交易流水号',
  ...
  KEY `idx_deposit_id` (`deposit_id`),
  KEY `idx_seq_no` (`seq_no`)
) ENGINE=InnoDB AUTO_INCREMENT=60854 DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Table structure for deposit_from_bigdata_copy202006021415
-- ----------------------------
DROP TABLE IF EXISTS `deposit_from_bigdata_copy202006021415`;
CREATE TABLE `deposit_from_bigdata_copy202006021415` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT,
  `deposit_id` bigint(11) DEFAULT NULL COMMENT '入金主键',
  `bank` varchar(20) DEFAULT NULL COMMENT '用户的入金汇入的银行，取值（BOC， DBS）',
  `seq_no` varchar(64) DEFAULT NULL COMMENT '交易流水号',
  ...
  KEY `idx_deposit_id` (`deposit_id`),
  KEY `idx_seq_no` (`seq_no`)
) ENGINE=InnoDB AUTO_INCREMENT=67545 DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Table structure for deposit_from_bigdata_copy202006021522
-- ----------------------------
DROP TABLE IF EXISTS `deposit_from_bigdata_copy202006021522`;
CREATE TABLE `deposit_from_bigdata_copy202006021522` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT,
  `deposit_id` bigint(11) DEFAULT NULL COMMENT '入金主键',
  `bank` varchar(20) DEFAULT NULL COMMENT '用户的入金汇入的银行，取值（BOC， DBS）',
  `seq_no` varchar(64) DEFAULT NULL COMMENT '交易流水号',
  ...
  KEY `idx_deposit_id` (`deposit_id`),
  KEY `idx_seq_no` (`seq_no`)
) ENGINE=InnoDB AUTO_INCREMENT=67657 DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Table structure for deposit_from_bigdata_copy202006091013
-- ----------------------------
DROP TABLE IF EXISTS `deposit_from_bigdata_copy202006091013`;
CREATE TABLE `deposit_from_bigdata_copy202006091013` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT,
  `deposit_id` bigint(11) DEFAULT NULL COMMENT '入金主键',
  `bank` varchar(20) DEFAULT NULL COMMENT '用户的入金汇入的银行，取值（BOC， DBS）',
  `seq_no` varchar(64) DEFAULT NULL COMMENT '交易流水号',
  ...
  KEY `idx_deposit_id` (`deposit_id`),
  KEY `idx_seq_no` (`seq_no`)
) ENGINE=InnoDB AUTO_INCREMENT=71941 DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Table structure for deposit_from_bigdata_copy202006111649
-- ----------------------------
DROP TABLE IF EXISTS `deposit_from_bigdata_copy202006111649`;
CREATE TABLE `deposit_from_bigdata_copy202006111649` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT,
  `deposit_id` bigint(11) DEFAULT NULL COMMENT '入金主键',
  `bank` varchar(20) DEFAULT NULL COMMENT '用户的入金汇入的银行，取值（BOC， DBS）',
  `seq_no` varchar(64) DEFAULT NULL COMMENT '交易流水号',
  ...
  KEY `idx_deposit_id` (`deposit_id`),
  KEY `idx_seq_no` (`seq_no`)
) ENGINE=InnoDB AUTO_INCREMENT=73499 DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Table structure for deposit_from_bigdata_copy202006161030
-- ----------------------------
DROP TABLE IF EXISTS `deposit_from_bigdata_copy202006161030`;
CREATE TABLE `deposit_from_bigdata_copy202006161030` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT,
  `deposit_id` bigint(11) DEFAULT NULL COMMENT '入金主键',
  `bank` varchar(20) DEFAULT NULL COMMENT '用户的入金汇入的银行，取值（BOC， DBS）',
  `seq_no` varchar(64) DEFAULT NULL COMMENT '交易流水号',
  ...
  KEY `idx_deposit_id` (`deposit_id`),
  KEY `idx_seq_no` (`seq_no`)
) ENGINE=InnoDB AUTO_INCREMENT=74618 DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Table structure for deposit_from_bigdata_copy202006181448
-- ----------------------------
DROP TABLE IF EXISTS `deposit_from_bigdata_copy202006181448`;
CREATE TABLE `deposit_from_bigdata_copy202006181448` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT,
  `deposit_id` bigint(11) DEFAULT NULL COMMENT '入金主键',
  `bank` varchar(20) DEFAULT NULL COMMENT '用户的入金汇入的银行，取值（BOC， DBS）',
  `seq_no` varchar(64) DEFAULT NULL COMMENT '交易流水号',
  ...
  KEY `idx_deposit_id` (`deposit_id`),
  KEY `idx_seq_no` (`seq_no`)
) ENGINE=InnoDB AUTO_INCREMENT=77119 DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Table structure for deposit_from_bigdata_copy_20200104
-- ----------------------------
DROP TABLE IF EXISTS `deposit_from_bigdata_copy_20200104`;
CREATE TABLE `deposit_from_bigdata_copy_20200104` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT,
  `deposit_id` bigint(11) DEFAULT NULL COMMENT '入金主键',
  `bank` varchar(20) DEFAULT NULL COMMENT '用户的入金汇入的银行，取值（BOC， DBS）',
  `seq_no` varchar(20) DEFAULT NULL COMMENT '交易流水号',
  ...
  `amount` varchar(20) DEFAULT NULL COMMENT '金额',
  `debit_direction` varchar(20) DEFAULT NULL COMMENT '借贷方向，取值：C：入金，D：出金',
  `reciprocal_account` varchar(20) DEFAULT NULL COMMENT '对方账号,出入金用户的银行账号',
  `reciprocal_account_name` longtext COMMENT '对方账号名称',
  `reciprocal_account_bank` longtext COMMENT '对方开户银行',
  `reciprocal_account_address` varchar(20) DEFAULT NULL COMMENT '对方开户地',
  `transfer_bank` varchar(20) DEFAULT NULL COMMENT '中转银行',
  ...
  PRIMARY KEY (`id`),
  KEY `idx_deposit_id` (`deposit_id`)
) ENGINE=InnoDB AUTO_INCREMENT=28984 DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Table structure for deposit_from_bigdata_copy_202001061938
-- ----------------------------
DROP TABLE IF EXISTS `deposit_from_bigdata_copy_202001061938`;
CREATE TABLE `deposit_from_bigdata_copy_202001061938` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT,
  `deposit_id` bigint(11) DEFAULT NULL COMMENT '入金主键',
  `bank` varchar(20) DEFAULT NULL COMMENT '用户的入金汇入的银行，取值（BOC， DBS）',
  `seq_no` varchar(20) DEFAULT NULL COMMENT '交易流水号',
  ...
  PRIMARY KEY (`id`),
  KEY `idx_deposit_id` (`deposit_id`)
) ENGINE=InnoDB AUTO_INCREMENT=29958 DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Table structure for deposit_from_bigdata_copy_202001070931
-- ----------------------------
DROP TABLE IF EXISTS `deposit_from_bigdata_copy_202001070931`;
CREATE TABLE `deposit_from_bigdata_copy_202001070931` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT,
  `deposit_id` bigint(11) DEFAULT NULL COMMENT '入金主键',
  `bank` varchar(20) DEFAULT NULL COMMENT '用户的入金汇入的银行，取值（BOC， DBS）',
  `seq_no` varchar(20) DEFAULT NULL COMMENT '交易流水号',
  ...
  PRIMARY KEY (`id`),
  KEY `idx_deposit_id` (`deposit_id`)
) ENGINE=InnoDB AUTO_INCREMENT=30482 DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Table structure for deposit_from_bigdata_copy_202001071811
-- ----------------------------
DROP TABLE IF EXISTS `deposit_from_bigdata_copy_202001071811`;
CREATE TABLE `deposit_from_bigdata_copy_202001071811` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT,
  `deposit_id` bigint(11) DEFAULT NULL COMMENT '入金主键',
  `bank` varchar(20) DEFAULT NULL COMMENT '用户的入金汇入的银行，取值（BOC， DBS）',
  `seq_no` varchar(20) DEFAULT NULL COMMENT '交易流水号',
...
) ENGINE=InnoDB AUTO_INCREMENT=23482 DEFAULT CHARSET=utf8mb4 COMMENT='子账号信息';
...
CREATE TABLE `deposite_bank_info` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=91 DEFAULT CHARSET=utf8mb4 COMMENT='银证转账入金银行信息';
...
CREATE TABLE `deposite_bind_bank_card` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6602 DEFAULT CHARSET=utf8mb4 COMMENT='银证转账用户绑卡状态';
...
) ENGINE=InnoDB AUTO_INCREMENT=23722 DEFAULT CHARSET=utf8mb4 COMMENT='子账户申请记录';
...
CREATE TABLE `deposite_transfer_detail` (
  ...
  `send_msg_time` datetime DEFAULT NULL COMMENT '发送大数据队列更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13873 DEFAULT CHARSET=utf8mb4 COMMENT='银证转账入金记录表';
...
CREATE TABLE `id_info` (
  ...
  `employment` varchar(10) DEFAULT NULL COMMENT '就业情况',
  ...
  `id_ustype` varchar(50) DEFAULT NULL COMMENT ' 美国开户证件类型 0是大陆身份证 1SSN 2中国内地护照 3中国香港护照 4中国澳门护照 5中国台湾护照 6加拿大护照',
...
CREATE TABLE `information_disclosure` (
  ...
  `email` varchar(50) DEFAULT NULL COMMENT '邮箱',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=32374 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `investment_situation` (
  ...
  `risk_off` varchar(10) DEFAULT NULL COMMENT '风险厌恶(不愿意投资）',
  `investment_objectives` varchar(10) DEFAULT NULL COMMENT '投资目标',
  `stock_exp` varchar(10) DEFAULT NULL COMMENT '证券经验',
  `fund_exp` varchar(10) DEFAULT NULL COMMENT '基金经验',
  `foreign_exchange_exp` varchar(10) DEFAULT NULL COMMENT '外汇经验',
  `income_exp` varchar(10) DEFAULT NULL COMMENT '固收经验',
  `other_exp` varchar(10) DEFAULT NULL COMMENT '其他经验',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=32227 DEFAULT CHARSET=utf8mb4;
...
) ENGINE=InnoDB AUTO_INCREMENT=1921923 DEFAULT CHARSET=utf8mb4;
...
) ENGINE=InnoDB AUTO_INCREMENT=70868 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `open_account_first_result` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_account_id` (`account_id`)
) ENGINE=InnoDB AUTO_INCREMENT=73775 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `risk_assessment` (
  ...
  `other_exp` varchar(10) DEFAULT NULL COMMENT '投资期限',
  `investment_objectives` varchar(10) DEFAULT NULL COMMENT '投资目标',
  `risk_off` varchar(10) DEFAULT NULL COMMENT '风险厌恶(不愿意投资）',
  `risk_tolerance` varchar(10) DEFAULT NULL COMMENT '最想拥有的投资',
  `step` varchar(5) DEFAULT NULL COMMENT '步骤',
  `total_score` int(5) DEFAULT '0' COMMENT '总分',
...
CREATE TABLE `stock_transfer_audit` (
  ...
  `inset_time` datetime DEFAULT NULL COMMENT '审核时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4165 DEFAULT CHARSET=utf8mb4 COMMENT='增开美股中华通市场，审核日志';
...
CREATE TABLE `stock_transfer_detail` (
  ...
  `trader_name` varchar(30) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=166024 DEFAULT CHARSET=utf8mb4 COMMENT='出金审核';

-- ----------------------------
-- Table structure for transfer_cash_audit_202005211550
-- ----------------------------
DROP TABLE IF EXISTS `transfer_cash_audit_202005211550`;
CREATE TABLE `transfer_cash_audit_202005211550` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `transfer_money_apply_id` int(11) DEFAULT NULL COMMENT '出金申请',
  `state` int(11) DEFAULT NULL COMMENT '1001_初审 1002_初审通过 1003_初审不通过 2001_结算员通过 2002_结算员不通过 1004_驳回通过 1005_驳回不通过 3001_会计转账成功 3002_会计转账失败 1006_交易员重新出金 1007_交易员重新入金 3003_会计退款成功 4000 用户撤回',
  `audit_role` tinyint(4) DEFAULT NULL COMMENT '审核角色  1_交易员 2_结算员 3_会计',
  ...
  PRIMARY KEY (`id`),
  KEY `idx_transfer_money_apply_id` (`transfer_money_apply_id`)
) ENGINE=InnoDB AUTO_INCREMENT=126188 DEFAULT CHARSET=utf8mb4 COMMENT='出金审核';

-- ----------------------------
-- Table structure for transfer_cash_audit_copy202004161820
-- ----------------------------
DROP TABLE IF EXISTS `transfer_cash_audit_copy202004161820`;
CREATE TABLE `transfer_cash_audit_copy202004161820` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `transfer_money_apply_id` int(11) DEFAULT NULL COMMENT '出金申请',
  `state` int(11) DEFAULT NULL COMMENT '1001_初审 1002_初审通过 1003_初审不通过 2001_结算员通过 2002_结算员不通过 1004_驳回通过 1005_驳回不通过 3001_会计转账成功 3002_会计转账失败 1006_交易员重新出金 1007_交易员重新入金 3003_会计退款成功 4000 用户撤回',
  `audit_role` tinyint(4) DEFAULT NULL COMMENT '审核角色  1_交易员 2_结算员 3_会计',
  ...
  PRIMARY KEY (`id`),
  KEY `idx_transfer_money_apply_id` (`transfer_money_apply_id`)
) ENGINE=InnoDB AUTO_INCREMENT=98290 DEFAULT CHARSET=utf8mb4 COMMENT='出金审核';

-- ----------------------------
-- Table structure for transfer_cash_audit_copy202005061743
-- ----------------------------
DROP TABLE IF EXISTS `transfer_cash_audit_copy202005061743`;
CREATE TABLE `transfer_cash_audit_copy202005061743` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `transfer_money_apply_id` int(11) DEFAULT NULL COMMENT '出金申请',
  `state` int(11) DEFAULT NULL COMMENT '1001_初审 1002_初审通过 1003_初审不通过 2001_结算员通过 2002_结算员不通过 1004_驳回通过 1005_驳回不通过 3001_会计转账成功 3002_会计转账失败 1006_交易员重新出金 1007_交易员重新入金 3003_会计退款成功 4000 用户撤回',
  `audit_role` tinyint(4) DEFAULT NULL COMMENT '审核角色  1_交易员 2_结算员 3_会计',
  ...
  PRIMARY KEY (`id`),
  KEY `idx_transfer_money_apply_id` (`transfer_money_apply_id`)
) ENGINE=InnoDB AUTO_INCREMENT=112080 DEFAULT CHARSET=utf8mb4 COMMENT='出金审核';
...
CREATE TABLE `transfer_frenquently_bank` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=27196 DEFAULT CHARSET=utf8mb4 COMMENT='常用银行表';

-- ----------------------------
-- Table structure for transfer_frenquently_bank_202004231400
-- ----------------------------
DROP TABLE IF EXISTS `transfer_frenquently_bank_202004231400`;
CREATE TABLE `transfer_frenquently_bank_202004231400` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `bank_type_id` int(11) DEFAULT NULL COMMENT '银行分类id',
  `bank_type_name` varchar(38) DEFAULT NULL COMMENT '银行分类名称',
  `bank_id` int(3) DEFAULT NULL COMMENT '银行id',
  ...
  `address` varchar(255) DEFAULT NULL COMMENT '居住地址',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16983 DEFAULT CHARSET=utf8mb4 COMMENT='常用银行表';
...
CREATE TABLE `transfer_money_apply` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=58588 DEFAULT CHARSET=utf8mb4 COMMENT='出金记录';

-- ----------------------------
-- Table structure for transfer_money_apply_202004231400
-- ----------------------------
DROP TABLE IF EXISTS `transfer_money_apply_202004231400`;
CREATE TABLE `transfer_money_apply_202004231400` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `bank_type_id` int(3) DEFAULT NULL COMMENT '银行分类id',
  `bank_type_name` varchar(38) DEFAULT NULL COMMENT '银行分类名字-收款银行',
  `bank_id` int(3) DEFAULT NULL COMMENT '银行id-收款银行',
  ...
  `msg_id` varchar(50) DEFAULT NULL COMMENT '大数据自动转账流水号',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=38434 DEFAULT CHARSET=utf8mb4 COMMENT='出金记录';

-- ----------------------------
-- Table structure for transfer_money_apply_202005061743
-- ----------------------------
DROP TABLE IF EXISTS `transfer_money_apply_202005061743`;
CREATE TABLE `transfer_money_apply_202005061743` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `bank_type_id` int(3) DEFAULT NULL COMMENT '银行分类id',
  `bank_type_name` varchar(38) DEFAULT NULL COMMENT '银行分类名字-收款银行',
  `bank_id` int(3) DEFAULT NULL COMMENT '银行id-收款银行',
  ...
  `msg_id` varchar(50) DEFAULT NULL COMMENT '大数据自动转账流水号',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=43031 DEFAULT CHARSET=utf8mb4 COMMENT='出金记录';

-- ----------------------------
-- Table structure for transfer_money_apply_202005211550
-- ----------------------------
DROP TABLE IF EXISTS `transfer_money_apply_202005211550`;
CREATE TABLE `transfer_money_apply_202005211550` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `bank_type_id` int(3) DEFAULT NULL COMMENT '银行分类id',
  `bank_type_name` varchar(38) DEFAULT NULL COMMENT '银行分类名字-收款银行',
  `bank_id` int(3) DEFAULT NULL COMMENT '银行id-收款银行',
  ...
  `msg_id` varchar(50) DEFAULT NULL COMMENT '大数据自动转账流水号',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=47204 DEFAULT CHARSET=utf8mb4 COMMENT='出金记录';
...
CREATE TABLE `transfer_money_auto_record` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11522 DEFAULT CHARSET=utf8mb4;
