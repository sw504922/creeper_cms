/*
 ...
 Source Schema         : miningstock_us

 Target Server Type    : MySQL
 Target Server Version : 50721
 File Encoding         : 65001

 Date: 27/05/2022 15:24:10
*/
...
CREATE TABLE `abroadcard_register` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=708 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `app_manager_notice` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=176 DEFAULT CHARSET=utf8mb4 COMMENT='通知';
...
CREATE TABLE `app_manager_user` (
  ...
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=217 DEFAULT CHARSET=utf8mb4 COMMENT='后台管理人员';
...
CREATE TABLE `app_manager_user_role` (
  ...
  PRIMARY KEY (`ur_id`)
) ENGINE=InnoDB AUTO_INCREMENT=71 DEFAULT CHARSET=utf8mb4 COMMENT='后台管理角色关系表';
...
) ENGINE=InnoDB AUTO_INCREMENT=77159 DEFAULT CHARSET=utf8mb4 COMMENT='推送配置表';
...
CREATE TABLE `bos_everyday_trade_statement` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=70153 DEFAULT CHARSET=utf8mb4 COMMENT='记录每天有交易行为用户';
...
CREATE TABLE `channels_and_settlement` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='运营渠道结算股票发放记录表';
...
) ENGINE=InnoDB AUTO_INCREMENT=281004 DEFAULT CHARSET=utf8;
...
CREATE TABLE `employee_level2` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=170 DEFAULT CHARSET=utf8mb4 COMMENT='员工使用L2表';
...
CREATE TABLE `exchange_user_info` (
  ...
  PRIMARY KEY (`id`),
  KEY `userId` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=327627 DEFAULT CHARSET=utf8mb4;
...
) ENGINE=InnoDB AUTO_INCREMENT=2075 DEFAULT CHARSET=utf8mb4 COMMENT='金账户用户订阅记录';
...
CREATE TABLE `keep_news` (
  ...
  PRIMARY KEY (`news_id`)
) ENGINE=InnoDB AUTO_INCREMENT=12248 DEFAULT CHARSET=utf8;
...
CREATE TABLE `lv2_daily` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3567 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `lv2_monthly_used` (
  ...
  `market` char(5) DEFAULT NULL COMMENT 'A_a股  US_美股 HK_港股',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=149673 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `lv2_user_information` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11165 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `mock_position` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1509 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `my_message` (
  ...
  PRIMARY KEY (`msg_id`)
) ENGINE=InnoDB AUTO_INCREMENT=58150 DEFAULT CHARSET=utf8;
...
CREATE TABLE `news_read` (
  ...
  PRIMARY KEY (`read_id`)
) ENGINE=InnoDB AUTO_INCREMENT=407510 DEFAULT CHARSET=utf8mb4;
...
) ENGINE=InnoDB AUTO_INCREMENT=26724 DEFAULT CHARSET=utf8;
...
CREATE TABLE `opt_coupon_product` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='我的卡券产品列表';
...
CREATE TABLE `opt_coupon_transaction` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='卡券活动交易行为明细';
...
) ENGINE=InnoDB AUTO_INCREMENT=1845808 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `opt_invite_account` (
  ...
  KEY `idx_user_id` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=180305 DEFAULT CHARSET=utf8mb4 COMMENT='邀请开户';
...
CREATE TABLE `opt_invite_cash_history` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=19769 DEFAULT CHARSET=utf8mb4;
...
) ENGINE=InnoDB AUTO_INCREMENT=391493 DEFAULT CHARSET=utf8mb4 COMMENT='邀请开户奖励';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='用户卡券列表';
...
) ENGINE=InnoDB AUTO_INCREMENT=1132 DEFAULT CHARSET=utf8mb4 COMMENT='运营电话号记录相关表';
...
) ENGINE=InnoDB AUTO_INCREMENT=2681 DEFAULT CHARSET=utf8mb4 COMMENT='运营相关活动全免申请记录';
...
CREATE TABLE `opt_wechat_subscribe` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9922 DEFAULT CHARSET=utf8mb4 COMMENT='微信公众号关注记录表';
...
-- ----------------------------
-- Table structure for opt_wechat_user_bak01
-- ----------------------------
DROP TABLE IF EXISTS `opt_wechat_user_bak01`;
CREATE TABLE `opt_wechat_user_bak01` (
  `wx_openid` varchar(64) NOT NULL COMMENT '关注公众号的微信用户id',
  `area_country_code` varchar(8) DEFAULT '+86',
  `mobile_phone_number` varchar(20) DEFAULT NULL,
  `aes_phone` varchar(128) DEFAULT NULL COMMENT '手机号（加盐）的aes',
...
CREATE TABLE `opt_wheel_disc_record` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16131 DEFAULT CHARSET=utf8mb4 COMMENT='轮盘记录表';
...
CREATE TABLE `opt_wheel_disc_stock` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8mb4 COMMENT='轮盘活动股票列表';
...
) ENGINE=InnoDB AUTO_INCREMENT=1873376 DEFAULT CHARSET=utf8;
...
CREATE TABLE `optional_stock_cancel` (
  ...
  `code` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`optional_id`)
) ENGINE=InnoDB AUTO_INCREMENT=308599 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=86186 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `report_at_level2_detail` (
  ...
  KEY `insert_date` (`insert_date`),
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=152347 DEFAULT CHARSET=utf8mb4 COMMENT='AT上报数据详情表';
...
CREATE TABLE `sms_receipt` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=94010 DEFAULT CHARSET=utf8mb4 COMMENT='短信回执';
...
CREATE TABLE `sms_result` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1334897 DEFAULT CHARSET=utf8mb4 COMMENT='短信发送结果';
...
CREATE TABLE `stock_info` (
  ...
  KEY `code` (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=170428 DEFAULT CHARSET=utf8;
...
CREATE TABLE `user` (
  ...
  `register_area` varchar(30) DEFAULT 'USA' COMMENT '原始注册地区（目前只有两个注册地香港HKG，美国USA）',
...
) ENGINE=InnoDB AUTO_INCREMENT=375422 DEFAULT CHARSET=utf8mb4;
...
) ENGINE=InnoDB AUTO_INCREMENT=319147 DEFAULT CHARSET=utf8mb4;
...
) ENGINE=InnoDB AUTO_INCREMENT=155224 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `user_first_login_device` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8mb4 COMMENT='用户首次登录记录表';
...
) ENGINE=InnoDB AUTO_INCREMENT=74633 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `user_new_stock_message` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=70565 DEFAULT CHARSET=utf8mb4;
...
) ENGINE=InnoDB AUTO_INCREMENT=326913 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `zj_event` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=559740 DEFAULT CHARSET=utf8mb4;
...
-- ----------------------------
-- Table structure for zj_index_component_202006280615
-- ----------------------------
DROP TABLE IF EXISTS `zj_index_component_202006280615`;
CREATE TABLE `zj_index_component_202006280615` (
  `market` varchar(10) DEFAULT NULL COMMENT '市场',
  `index_code` varchar(50) DEFAULT NULL COMMENT '指数代码',
  `constituent_exchange` varchar(20) DEFAULT NULL,
  `constituent_code` varchar(50) DEFAULT NULL COMMENT '成分股代码',
...
CREATE TABLE `zj_ipo_qty_temp` (
  ...
  PRIMARY KEY (`id`),
  KEY `Index 2` (`code`,`ipo_date`)
) ENGINE=InnoDB AUTO_INCREMENT=113985 DEFAULT CHARSET=utf8mb4 COMMENT='数量金额梯度表，即一个新股的‘申购股数’，‘所需金额’的对应关系，主要用于港股，数据是从批露易上抓取\r\n通过 code,ipo_date字段和zj_shareipo表相关联\r\n\r\n';
...
CREATE TABLE `zj_shareipo_temp` (
  ...
  `placing_min_qty` int(11) DEFAULT NULL COMMENT '最小配售股数',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=252381 DEFAULT CHARSET=utf8mb4 COMMENT='美港股IPO信息,\r\n业务唯一性 code,ipo_date,\r\n通过 code,ipo_date字段和''数量金额梯度''表相关联';
